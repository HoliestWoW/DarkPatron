...
local tutorialPages = {
    ...
    { title = "6. Sigils & Sovereign Awakening", icon = "Interface\\Icons\\Spell_Shadow_ShadowWordPain", header = "Endgame Bounties & High Gambles", text = "Hunt down Elites for Dark Sigils, or risk 30 Dark Favor via |cffffffffThe Sovereign Awakening|r for a 10% chance at an Apex Sigil.\n\n|cffffd700=> Look at the flashing Sovereign Awakening gamble card below!|r", action = function() if PatronsLedger then PatronsLedger:Show() end currentView = "bazaar" if Ledger and Ledger:IsShown() then Ledger:GetScript("OnShow")(Ledger) end HighlightCards(storeCardsList, {9}) end }
}
